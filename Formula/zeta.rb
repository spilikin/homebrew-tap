class Zeta < Formula
  ...
  url "https://github.com/gematik/zeta-cli/releases/download/v0.8.0/zeta-0.8.0.tar.gz"
  sha256 "c5e7f550d8b392bbe2a946ac3498fa0b1807c76ae0dade387b9cfeaf659446df"
  license "Apache-2.0"
